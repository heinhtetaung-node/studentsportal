            ...
            <div class="box-body">
                ...
                @if($errors->has('email'))
                     ...
                     <div class="form-group">
                        ...
                        @endif
                        <input name="email" type="email" class="form-control" id="email" placeholder="Enter email" value="{{ $student->email }}">
                     </div>
                ...
                @if($errors->has('phone'))
                    ...
                    <div class="form-group">
                        ...
                        @endif
                        <input name="phone" type="tel" class="form-control" id="phone" placeholder="Enter Phone Number" value="{{ $student->phone }}">
                    </div>
