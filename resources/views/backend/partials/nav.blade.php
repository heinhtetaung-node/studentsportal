<header class="main-header">
    ...
    <a href="{{ url('backend') }}" class="logo">
        ...
        <span class="logo-lg">{{ config('studentsportal.title') }}</span>
    </a>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ asset('dist/img/user3-128x128.jpg') }}dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Sales Department
